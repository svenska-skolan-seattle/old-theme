...
function theme_post_wrapper($args = '') {
	...
	?>
<div class="post<?php echo $class; ?>"<?php echo $id; ?>>
	    <div class="post-body">
...
function theme_simple_wrapper($args = '') {
	...
	if ( !theme_is_empty_html($title)) echo '<h5  class="widget-title">' . $title . '</h5>';
