<?php
define('THEME_NAME',"svenska skolan_seattle3");
global $wp_version;
...
function my_enqueued_assets() {
	...
	wp_enqueue_script('theme-script', get_template_directory_uri() . '/script.js', array('jquery'), '1.0.0', true);
}
